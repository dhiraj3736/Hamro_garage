                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.equals("Username or Email already registered!!")) {
                            Toast.makeText(edit_user_profile.this, "Email or phone number already exists!", Toast.LENGTH_SHORT).show();
                        } else if (response.equals("success")){
                            Toast.makeText(edit_user_profile.this, "Update successfully", Toast.LENGTH_SHORT).show();
